...
with open('NSElist.csv') as file:
    ...
    for row in reader:
        ...
        master_data = pd.concat([master_data, stock_data], ignore_index=True)

        print(f"Data for {symbol} appended to master data")
        print(stock_data.head())


output_filename = 'all_stock_data.csv'
